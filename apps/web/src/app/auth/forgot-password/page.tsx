        ...
        <div className="w-full max-w-md">
          <div className="text-center mb-8">
            ...
            {submitted ? (
              ...
              <>
                ...
                <h1 className="text-2xl font-bold">Şifrəni unutdunuz?</h1>
                <p className="text-muted-foreground mt-2">E-poçt ünvanınızı daxil edin, şifrə sıfırlama linki göndəracəq</p>
              </>
            )}
          </div>
          ...
          <Card>
            <CardHeader className="text-center">
              <CardTitle className="text-xl">{submitted ? "Yoxlayın e-poçtunuzu" : "Şifrəni sıfırla"}</CardTitle>
              <CardDescription>
                {submitted
                  ? "Şifrə sıfırlama linki e-poçt ünvanınıza göndərildi. Spam qovluğunu da yoxlayın."
                  : "E-poçt ünvanınızı daxil edin, şifrə sıfırlama linki göndəracəq"}
              </CardDescription>
            </CardHeader>
