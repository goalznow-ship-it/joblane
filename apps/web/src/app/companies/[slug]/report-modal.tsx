...
export default function ReportModal({ companyId, companyName, open, onClose }: ReportModalProps) {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      await reportApi.create("COMPANY", companyId, reason, description.trim() || undefined)
      setSuccess(true)
      setTimeout(() => {
        onClose()
        setSuccess(false)
